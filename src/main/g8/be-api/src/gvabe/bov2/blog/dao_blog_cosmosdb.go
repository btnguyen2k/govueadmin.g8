...
func NewBlogCommentDaoCosmosdb(sqlc *prom.SqlConnect, tableName string, txModeOnWrite bool) BlogCommentDao {
...
//
// Available since template-v0.3.0
func NewBlogPostDaoCosmosdb(sqlc *prom.SqlConnect, tableName string, txModeOnWrite bool) BlogPostDao {
...
//
// Available since template-v0.3.0
func NewBlogVoteDaoCosmosdb(sqlc *prom.SqlConnect, tableName string, txModeOnWrite bool) BlogVoteDao {
