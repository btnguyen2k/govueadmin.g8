<template>
    <div>
        <CRow>
            ...
            <CCol sm="6" lg="3">
                <CWidgetDropdown color="warning" v-bind:text="systemInfo.go_routines.num+''" header="Go Routines">
                    <template #default>
                        <CDropdown color="transparent p-0" placement="bottom-end">
                            <template #toggler-content>
                                <CIcon name="cil-settings"/>
            ...
            <CCol sm="6" lg="3">
                <CWidgetDropdown color="danger" v-bind:text="systemInfo.memory.freeGb+' Gb'" header="Free SystemMemory">
                    ...
                    <template #footer>
                        <CChartBarSimple class="mt-3 mx-3" style="height:70px" background-color="rgb(250, 152, 152)"
                                         :data-points="systemInfo.memory.history_freeGb"
                                         label="Free SystemMemory"/>
                    </template>
                </CWidgetDropdown>
            </CCol>
        </CRow>
